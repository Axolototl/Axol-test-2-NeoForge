...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, AxolTest2.MOD_ID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        buttonItem(ModBlocks.BLACK_OPAL_BUTTON, ModBlocks.RAW_BLACK_OPAL_BLOCK);
        ...
        basicItem(ModItems.AXOL_SMITHING_TEMPLATE.get());
    }

    // Shoutout to El_Redstoniano for making this
    private void trimmedArmorItem(DeferredItem<Item> itemDeferredItem) {
        final String MOD_ID = AxolTest2.MOD_ID; // Change this to your mod id
    ...
    public void buttonItem(DeferredBlock<Block> block, DeferredBlock<Block> baseBlock) {
        this.withExistingParent(block.getId().getPath(), mcLoc("block/button_inventory"))
                .texture("texture",  ResourceLocation.fromNamespaceAndPath(AxolTest2.MOD_ID,
    ...
    public void wallItem(DeferredBlock<Block> block, DeferredBlock<Block> baseBlock) {
        this.withExistingParent(block.getId().getPath(), mcLoc("block/wall_inventory"))
                .texture("wall",  ResourceLocation.fromNamespaceAndPath(AxolTest2.MOD_ID,
                        "block/" + baseBlock.getId().getPath()));
    }
    ...
    private ItemModelBuilder handheldItem(DeferredItem<Item> item) {
        return withExistingParent(item.getId().getPath(),
                ...
                ResourceLocation.fromNamespaceAndPath(AxolTest2.MOD_ID,"item/" + item.getId().getPath()));
    }
}